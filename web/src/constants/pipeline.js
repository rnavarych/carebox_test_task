// Order matches orchestrator: planner → analyzer → diff → generator → playwright → reporter
export const PIPELINE_STEPS = [
  ...
  { id: 'diff', name: 'Diff Analyzer', icon: '⚖️', color: 'yellow', bgColor: 'bg-yellow-500', description: 'Comparing templates and generating visual diffs' },
  { id: 'generator', name: 'Test Generator', icon: '🤖', color: 'indigo', bgColor: 'bg-indigo-500', description: 'AI generating dynamic test cases from test plan' },
  { id: 'playwright', name: 'Playwright Tests', icon: '🎭', color: 'pink', bgColor: 'bg-pink-500', description: 'Running AI-generated regression tests' },
